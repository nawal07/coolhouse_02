  ...
  return (
    <>
            ...
            <Col lg={6}>
              ...
              <p className="lead" style={{ fontSize: '1rem' }}>
                ...
                <span className="fw-bold">
                  General Deluxe (M. Abu Haltam Group for Investment)
                </span>
                , a leading Jordanian manufacturer of premium refrigeration
                solutions. We bring both{' '}
                <strong>commercial refrigeration equipment</strong> and{' '}
                <strong>home appliances</strong> to the Middle East market with
                unmatched quality and reliability, with a strong focus on Saudi
                Arabia.
              </p>
              <p className="mb-4">
                <strong>General Deluxe</strong> is one of the leading
                manufacturers in the Middle East, producing household and
                commercial electrical appliances in Jordan such as
                refrigerators, freezers, washing machines, A/C units, and
                upright freezers and fridges. General Deluxe's network has been
                expanded to cover Middle East, European, and African markets.
                Currently, we are exporting to countries like Saudi Arabia,
                Iraq, Egypt, Syria, Lebanon, Ghana, Tunisia, Algeria, Central
                Africa, and Cyprus.
              </p>
      ...
      <section className="section py-5" style={{ backgroundColor: '#e6f2ff' }}>
        <Container>
          <h2 className="section-heading">Why Choose General Deluxe</h2>
